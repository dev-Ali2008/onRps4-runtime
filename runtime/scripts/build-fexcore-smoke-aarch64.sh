...
GUEST_ENGINE_SOURCE="${PROJECT_ROOT}/runtime/sources/shadps4/src/core/fex/fex_guest_engine.cpp"
FEX_GUEST_CPU_SOURCE="${PROJECT_ROOT}/runtime/sources/shadps4/src/core/guest_cpu/fex_guest_cpu.cpp"
HLE_CALL_ADAPTER_SOURCE="${PROJECT_ROOT}/runtime/sources/shadps4/src/core/guest_cpu/hle_call_adapter.cpp"
FEX_HLE_BRIDGE_SOURCE="${PROJECT_ROOT}/runtime/sources/shadps4/src/core/guest_cpu/fex_hle_bridge.cpp"
...
cmake -S "${FEX_SOURCE}" -B "${BUILD_DIR}" -G Ninja \
  ...
  -DFEXCORE_PROJECT_SOURCE_DIR="${PROJECT_ROOT}/runtime/sources/shadps4/src" \
